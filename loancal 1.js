        ...
        window.onload = function () {
            ...
            loanForm.addEventListener('submit', function (e) {
                ...
                var monthly = 0,
                    ...
                    totalInterest = 0,
                    monthlyInterest = 0;
                monthlyInterest = (parseFloat(principalAmount) * (parseFloat(interest) / 100));
                pmt = parseFloat(monthlyInterest) / (1 - Math.pow(1 + ((parseFloat(interest) / 100)), -parseFloat(PayableYears)));
                total = parseFloat(pmt) * Math.floor(parseFloat(PayableYears));
